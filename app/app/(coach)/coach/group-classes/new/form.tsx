  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white rounded-xl border p-6 space-y-5">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">Rate per Student / Session (₹) *</label>
      ...
      <div className="flex gap-3 pt-2">
        ...
        <button type="button" onClick={() => router.back()} className="border px-5 py-2.5 rounded-lg text-sm hover:bg-gray-50">
          Cancel
        </button>
      </div>
    </form>
